...
<html lang="en">
  ...
  <body>
	...
	<div class="modal fade" id="signin" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
     ...
     <nav class="navbar navbar-fixed-top" style="background-color: #0BE0FD">
		  <div class="container-fluid">
			<div class="navbar-header">
			  ...
			  <a class="navbar-brand" href="#"><h1 style="font-family: jokerman">Art Gallery</h1></a>
			</div>
			<div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" s>
			  <ul class="nav navbar-nav navbar-right top_menu" style="background-color: #0BE0FD;">
				
				<li <?php if($page=="index") echo 'class="active"' ?>><a href="index.php" class="glyphicon glyphicon-home">Home <span class="sr-only">(current)</span></a></li>
				...
				<li <?php if($page=="contact_us") echo 'class="active"' ?>><a href="contact_us.php" class="glyphicon glyphicon-phone">Reach us</a></li>
